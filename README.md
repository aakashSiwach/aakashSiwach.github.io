...
- **Reach companies** — "Open to opportunities" badge, prominent **Hire me** CTA, one-click **Download CV** (real PDF file), and a no-backend contact form (`mailto:`).
...
└── assets/
    ├── Aakash_Siwach_Resume.pdf  # downloadable resume
